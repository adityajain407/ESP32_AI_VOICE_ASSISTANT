...
// ------------------------------------------------------------------------------------------------------------------------------
// ----------------  Adi Library - RECORDING audio, storing .wav on SD (variable sample/bit rate, gain booster) ---------------- 
// ----------------                                      July 22, 2024                                           ----------------
// ----------------                                                                                              ---------------- 
...
#define GAIN_BOOSTER_I2S          4   // original I2S streams is VERY silent, so we added an optional GAIN booster for INMP441
